...
describe('MovieService', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({ providers: [{ provide: MovieGateway, useValue: mockMoviesGateway }] });
  ...
  it('should return the correct data', (done) => {
    const subscription = service.getMovie(mockBody).subscribe((data) => {
  ...
  it('should call invoke and return error', (done) => {
    ...
    const subscription = service.getMovie(mockBody).subscribe((resp) => {
